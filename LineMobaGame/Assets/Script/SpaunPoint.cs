...
public class SpaunPoint : MonoBehaviour
{
    ...
    { 
        ...
        if (gameObject.name.Contains("mySpaun1") || gameObject.name.Contains("enemySpaun1"))
        {
            ...
            other.GetComponent<UnitLogic>().targets[1] = GameObject.Find("KT5");
            other.GetComponent<NavMeshAgent>().destination = other.GetComponent<UnitLogic>().targets[1].transform.position;
            other.GetComponent<UnitLogic>().targets[0] = other.GetComponent<UnitLogic>().targets[1];
        ...
        if (gameObject.name.Contains("mySpaun2") || gameObject.name.Contains("enemySpaun2"))
        {
            ...
            other.GetComponent<UnitLogic>().targets[1] = GameObject.Find("KT3");
            other.GetComponent<NavMeshAgent>().destination = other.GetComponent<UnitLogic>().targets[1].transform.position;
            other.GetComponent<UnitLogic>().targets[0] = other.GetComponent<UnitLogic>().targets[1];
        ...
        if (gameObject.name.Contains("mySpaun3") || gameObject.name.Contains("enemySpaun3"))
        {
            ...
            other.GetComponent<UnitLogic>().targets[1] = GameObject.Find("KT4");
            other.GetComponent<NavMeshAgent>().destination = other.GetComponent<UnitLogic>().targets[1].transform.position;
            other.GetComponent<UnitLogic>().targets[0] = other.GetComponent<UnitLogic>().targets[1];
        }
